...
image:https://img.shields.io/badge/WordPress-8.1%2B-21759b[WordPress]
...
cp -r zotpress /path/to/wordpress/wp-content/plugins/
----
...
# JavaScript/ReScript tooling (uses Deno, not npm)
deno task build
